...
public class StreamTest {
    ...
    public void testFromString() throws Exception {
        ...
        assertEquals("Stream.fromString not producing correct hash value", val, stream.hash());
    }
    ...
    public void testIsSameAs() throws Exception {
        ...
        assertEquals("Stream.fromString not producing correct hash value", stream1.hash(), stream2.hash());
    }
}
