...
public class TestUtil {
    ...
    /**
     * All results extend {@link APIDataSiftResult} which provides some methods for checking the state of every API
    ...
    public <T extends APIDataSiftResult> void successful(FutureData<T> resultFutureData) {
