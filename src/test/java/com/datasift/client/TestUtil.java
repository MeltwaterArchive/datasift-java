...
public class TestUtil {
    ...
    /**
     * All results extend {@link DataSiftAPIResult} which provides some methods for checking the state of every API
    ...
    public <T extends DataSiftAPIResult> void successful(FutureData<T> resultFutureData) {
