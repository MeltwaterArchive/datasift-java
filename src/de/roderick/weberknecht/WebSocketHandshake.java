...
{	
	...
	// Modified by Stuart Dallas, 3ft9 Ltd
	// Header param required to send the DataSift auth header
	public byte[] getHandshake(String header)
	{
		...
		handshake += "Upgrade: WebSocket\r\n" +
				...
				"Origin: " + origin + "\r\n" +
				// Added by Stuart Dallas, 3ft9 Ltd
				// Required to send the DataSift auth header
				header +
				"\r\n";
