/**
 * This example pauses one or more push subscriptions in your account.
 */
...
public class Pause {
	...
	public static void main(String[] args) {
		...
		if (Env.getArgCount() == 0) {
			System.err.println("Please specify one or more subscriptions to pause!");
			System.exit(1);
		}
		...
		for (int i = 0; i < Env.getArgCount(); i++) {
			try {
				...
				System.out.print("Pausing " + subscription_id + ", " + sub.getName() + "...");
				sub.pause();
